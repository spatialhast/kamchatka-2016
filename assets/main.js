var layerTopomapper = new L.tileLayer('//144.76.234.107/cgi-bin/ta/tilecache.py/1.0.0/topomapper_v2/{z}/{x}/{y}.jpg', {
    maxNativeZoom: 13,
    attribution: 'Tiles: &copy; <a href="http://nakarte.tk/" target="_blank">nakarte.tk</a>'
});

var layerOpenTopoMap = new L.TileLayer('//{s}.tile.opentopomap.org/{z}/{x}/{y}.png', {
		minZoom: 1,
		maxZoom: 17,
		detectRetina: true,
...
var layerOpenCycleMap = new L.tileLayer('//{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png', {
	maxZoom: 18,
	attribution: 'Map data: &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank">OpenStreetMap contributors</a>, under ODbL | Tiles: &copy; ' + '<a href="http://www.opencyclemap.org/" target="_blank">OpenCycleMap</a>'
       ...
       var layerMapboxImagery = new L.tileLayer('//api.tiles.mapbox.com/v4/mapbox.satellite/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiaGFzdCIsImEiOiJjaXU5dWY2ZmowMDAwMnltZGpudHljYWg2In0.9ZcYfFSe65DvQq6qkYcmWg', {
            maxZoom: 17,                          
...
var layerBingAerial = new BingLayer('//t{s}.tiles.virtualearth.net/tiles/a{q}.jpeg?g=2732', {
...
var layerTopo1000 = new L.tileLayer('//{s}.tiles.nakarte.tk/topo1000/{z}/{x}/{y}', {
  tms: true,
  maxNativeZoom: 13,
  attribution: 'Tiles: &copy; <a href="http://nakarte.tk/" target="_blank">nakarte.tk</a>'
});
